...
#include "rtmp_ms.h" 
extern "C" {
#include <libavutil/mem.h>            // av_malloc, av_free, av_realloc
#include <libavutil/samplefmt.h>      // AVSampleFormat 等（如果用到了）
#include <libavutil/channel_layout.h> // AV_CH_LAYOUT_MONO 等（如果用到了）
#include <libavutil/opt.h>            // av_opt_*（如果用到了）
#include <libavcodec/avcodec.h>       // AVCodec, AVCodecContext, avcodec_*（如果用到了）
}
#ifdef __cplusplus
extern "C" {
#endif
